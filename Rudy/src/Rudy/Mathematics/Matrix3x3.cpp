...
namespace Rudy
{
	...
	Matrix3x3::Matrix3x3(float a0, float a1, float a2, float b0, float b1, float b2, float c0, float c1, float c2)
	{
		A0 = a0;
		A1 = a1;
		A2 = a2;
	...
	bool Matrix3x3::IsInvertable() const
	{
